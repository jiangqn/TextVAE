...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, k: Tensor, v: Tensor, q: Tensor, mask: Tensor = None) -> torch.Tensor:
        """
        :param k: torch.FloatTensor (batch_size, seq_len, hidden_size)
        :param v: torch.FloatTensor (batch_size, seq_len, hidden_size)
